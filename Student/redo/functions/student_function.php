<?php
   ...
   function fetchAllStudAppointment($conn, $StudId){
      ...
      WHERE `student_id` = '$StudId' ORDER BY `app_appointed` DESC";
   ...
   function insertNewAppointment($conn, $ref_no, $stud_id, $appType, $appReason, $appDate, $appTime, $dateApply, $qrName){
      ...
      (`reference_no`, `student_id`, `app_appointed`,`app_type`, `app_reason`, `app_date`, `app_time`, `date_apply`, `app_status`, `app_qr`) 
      VALUES 
      ('$ref_no','$stud_id',NOW(),'$appType','$appReason','$appDate','$appTime','$dateApply','scheduled', '$qrName')";
