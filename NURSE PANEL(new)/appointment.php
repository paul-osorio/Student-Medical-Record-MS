...
<head>
    ...
    <title>Appointment | SMRMS | NURSE</title>
                                ...
                                <tbody>
                                    <a href="#" class="nav-link">
                                        <tr>        
                                            ...
                                            <td>nodata</td>
                                            <td><?php echo $row['type_of_concerned']; ?>></td>
                                            <td><?php echo $row['date']?></td>
                                            <td><?php echo $row['time_of_admission']?></td>
                                            <td>no db </td>
                                            <td><button class="btn btn-warning rounded-pill px-3"><?php echo $row['status']?></button></td>
                                        </tr>
                                </tbody>
                                <?php }
                        }
