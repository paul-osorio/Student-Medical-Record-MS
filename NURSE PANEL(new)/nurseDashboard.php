  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="color:#42BB56;">Cleared</td>
        ...
        <!-- PATIENTS -->
            ...
            <?php if(mysqli_num_rows($fetchAddPatients) > 0) { 
              ...
              <tr class="container">
                ...
                <td><button class="addpatient-btn" style="background-color: #163666;" data-tab-target="#viewpage">View</button>  </td>
        ...
        <section id="viewpage" class="viewpage so_content" data-tab-content>
<div class="viewheader">
<button class="addpatient-btn" style="background-color: #163666; float:right;" data-tab-target="#patient"><span aria-hidden="true">&times;</span></button>
  <h2> Patient List > Jessica O. Bulleque </h2>
  <hr>
  </div>
  <div class="container">
  <div class="row">
...
<div class="row">
  ...
  <div class="container">
      <div class="nav">
        ...
        <input type="button" value="Medical Requirements">
        <input type="button" class="btn-newconsult" value="New Consultation">
      </div>
