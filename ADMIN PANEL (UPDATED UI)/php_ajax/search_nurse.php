<?php
   ...
   if(isset($_POST['search'])){
      ...
      $search_nurse_query = "SELECT * FROM `nurses` WHERE  `emp_id` LIKE '%$search%' OR `email` LIKE '%$search%' OR `firstname` LIKE '%$search%' OR `lastname` LIKE '%$search%' OR `contact_num` LIKE '%$search%';"; 
      
      $fetchAllNurses = mysqli_query($conn, $search_nurse_query);
