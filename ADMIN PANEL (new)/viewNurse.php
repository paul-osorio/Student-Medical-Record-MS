...
<!--#################################################################################################################################################################################################################################-->
        ...
        <section id="nurses" class="nurses so_content so_active" data-tab-content>
            <div id="viewNurseInfo">
                        ...
                        <div class="nurse_header">
                          ...
                          <div class="actionbtn">
                              <a href="nurses.php" class="custom_btn" data-toggle="modal"><button onclick="history.back()">BACK</button></a>
                              <a href="editNurse.php" class="custom_btn" data-toggle="modal"><button onClick="myFunction()" style="background-color:green;">EDIT</button>
        ...
        <script>
            function myFunction() {
            window.location.href = "editNurse.php";
            }
        </script>
